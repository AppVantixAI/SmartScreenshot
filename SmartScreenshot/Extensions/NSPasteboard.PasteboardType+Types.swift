...
extension NSPasteboard.PasteboardType: Defaults.Serializable {
  ...
  // https://github.com/p0deje/SmartScreenshot/issues/429#issuecomment-1182575226
  static let modified = NSPasteboard.PasteboardType(rawValue: "x.nspasteboard.ModifiedType")

  // Marks that copy was made from SmartScreenshot.
  static let fromSmartScreenshot = NSPasteboard.PasteboardType(rawValue: "org.p0deje.SmartScreenshot")
