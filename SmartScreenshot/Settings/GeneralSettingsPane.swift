  ...
  var body: some View {
    Settings.Container(contentWidth: 450) {
      ...
      Settings.Section(
        ...
        KeyboardShortcuts.Recorder(for: .regionOCR)
          .help("Select a region of the screen and perform OCR to extract text")
        
        KeyboardShortcuts.Recorder(for: .appOCR)
          .help("Capture the active application window and perform OCR to extract text")
